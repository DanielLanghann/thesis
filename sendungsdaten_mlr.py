...
width = 0.35  # Breite der Bars
fig, ax = plt.subplots()
barchart_artsum = ax.bar(ind, art_sum, width, label='Anzahl pro Artikel', color = 'moccasin')
# Labeltext, Titel, x-axis tick labels, etc.
ax.set_ylabel('Anzahl')
...
y_delta_lt = lhm_sum_pro_lhm_y_test-lhm_sum_pro_lhm_y_pred
...
list = [sp_gesamt,sp_tasks_td,sp_tasks_od, sp_bugs, sp_storys,sp_mvp, sp_mvp_plus]
